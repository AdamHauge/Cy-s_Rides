...
public class OfferJdbcImpl implements OfferJdbc {
    ...
    public List<Offer> getDriverOffers() {
        ...
        for(int i=0 ; i<25 ; i++) {
            Offer offer = new Offer( 53180.08, null, "Des Moines", "Take me to Des Moines Yo", null);
            dummyList.add(offer);
        }
        return dummyList;
    }
...
//        String sqlQuery = "select * from PASSENGER_REQUESTS_TABLE";
        List<Offer> dummyList = new ArrayList<>();
        for(int i=0 ; i<5 ; i++) {
            Offer offer = new Offer(53180.08, null, "Des Moines", "I'm going to Des Moines Yo", null);
            dummyList.add(offer);
        }
        return dummyList;
    }
