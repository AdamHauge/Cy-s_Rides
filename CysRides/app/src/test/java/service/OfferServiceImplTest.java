...
public class OfferServiceImplTest extends EasyMockSupport {
    ...
    public void testGetOfferRequests_passenger() {
        ...
        Offer offer = new Offer(UserType.PASSENGER, 20, userInfo.getNetID(), "destination", "description", null);
    ...
    public void testGetOfferRequests_driver() {
        ...
        Offer offer = new Offer(UserType.DRIVER, 20, userInfo.getNetID(), "destination", "description", null);
        List<Offer> offerList = new ArrayList<>();
        offerList.add(offer);
        offerList.add(offer);
