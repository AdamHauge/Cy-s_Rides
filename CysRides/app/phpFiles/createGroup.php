...
$sql = "INSERT INTO GROUP_TABLE (DRIVER, RIDER_1, RIDER_2, RIDER_3, RIDER_4, RIDER_5, RIDER_6, RIDER_7) VALUES ('".$driver."','".$rider1."','".$rider2."','".$rider3."','".$rider4."','".$rider5."','".$rider6."','".$rider7."');";
